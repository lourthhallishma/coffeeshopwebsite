...
<html lang="en">
    <head>
        ...
        <title>Hallishma's Coffee shop</title>
    ...
    <body>
        ...
        <header class="header">
            ...
            <nav class="navbar navbar-expand-lg">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                            <a href="gift_shop.php" class="text-decoration-none">Gift Shop</a>
                        </li>
                        <li class="nav-item">
        ...
        <section class="home" id="home">
            <div class="content">
                <h3>Welcome to Hallishma's Coffee shop, <?php echo $_SESSION['username']; ?>!</h3>
                <p>
        ...
        <section class="about" id="about">
            ...
            <div class="row g-0">
                ...
                <div class="content">
                    <h3>Welcome to Hallishma's Coffee shop</h3>
                    <p>
                        At Hallishma's Coffee shop, we are passionate about coffee and believe
        ...
        <section class="footer">
            ...
            <div class="logo">
                    ...
                    <p>hallish@gmail.com</p><br />
                    <i class="fas fa-phone"></i>
                    <p>+91 917-134-1422</p><br />
                    <i class="fab fa-facebook-messenger"></i>
                    <p>@hallishmascoffeeshop</p><br />
                </div>
